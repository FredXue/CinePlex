...
<%@ include file="header.jsp" %>
    ...
    <link href="/Movie/css/buy.css" rel="stylesheet">
 <%
      ...
      <div class="seat-right">
        ...
        <li>
                    ...
                    <span class="offer J_originOffer"></span>
                        ...
                        <li class="total">
                    <label>总计:</label>
                    <div style="display:inline;padding-left:8px;">¥<span  data-price="3600"><%=plan.getPrice()*(1-((long)user.getRank())/10)%> x <i class="seat_count">0</i></span>
                    </div>
                </li>
            </ul>
        </div>
        <div class="seatForm">
            ...
            <ul style="padding-left:5px;">
                ...
                <li>
                    <%if(user.getState()==1){ %>
                    <a  class="btn" onclick="buyTicket(<%=plan.getPlan_id()%>)">确认信息，下单并支付</a>
                 <%}else{%>
                     <p>您的账号处于未激活状态，<a href="/Movie/memberInfo">请先激活！</a>    
                 <%}%>
                </li>
            </ul>
        </div>
